...
"""),format.raw/*89.1*/("""</script>
        ...
        <form action=""""),_display_(/*94.24*/routes/*94.30*/.ShoppingCtrl.placeOrder()),format.raw/*94.56*/("""" method="GET">
            <script
            src="https://checkout.stripe.com/checkout.js" class="stripe-button"
            data-key="pk_test_e9PCtT21TnhRh8b0iAgZ0erx"
            data-amount='"""),_display_(/*98.27*/("%.0f".format(customer.getBasket.getBasketTotal))),format.raw/*98.77*/("""00'
            data-name="Demo Site"

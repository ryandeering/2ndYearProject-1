...
<html>
  ...
  text-align: center;"""),format.raw/*20.22*/("""}"""),format.raw/*20.23*/("""
		...
		<title>OFM """),_display_(/*35.15*/pagename),format.raw/*35.23*/("""</title>
	</head>
	<body>
			...
			<div class="row">
				...
				<div class="col-sm-8">
					...
					<div class="container">
            				<div class="row">
                			<div class="col-md-12">
                    			<p class="lead"><!-- (at symbole) title --></p>
                		<div>
            			</div>

           			 <!-- Start Content -->
           			 """),_display_(/*80.17*/content),format.raw/*80.24*/("""
           			 """),format.raw/*81.16*/("""<!-- End Content -->

...
"""),format.raw/*279.1*/("""<div style="color:#999;" ></div>
            ...
            <div class="col-sm-6">
            <h4 style="color:#00b1b1;">"""),_display_(/*298.41*/user/*298.45*/.getfName()),format.raw/*298.56*/(""" """),_display_(/*298.58*/user/*298.62*/.getlName()),format.raw/*298.73*/("""</h4></span>
              <span><p>"""),_display_(/*299.25*/user/*299.29*/.getRole()),format.raw/*299.39*/("""</p></span>            
            </div>
            <div class="clearfix"></div>
            <hr style="margin:5px 0 5px 0;">
    
              
<div class="col-sm-5 col-xs-6 tital " >First Name:</div><div class="col-sm-7 col-xs-6 ">"""),_display_(/*305.90*/if(user!=null)/*305.104*/{_display_(_display_(/*305.106*/user/*305.110*/.getfName()))}),format.raw/*305.122*/("""</div>
     <div class="clearfix"></div>
<div class="bot-border"></div>

<div class="col-sm-5 col-xs-6 tital " >Last Name:</div><div class="col-sm-7">"""),_display_(/*309.79*/if(user!=null)/*309.93*/{_display_(_display_(/*309.95*/user/*309.99*/.getlName()))}),format.raw/*309.111*/("""</div>
  <div class="clearfix"></div>
<div class="bot-border"></div>

<div class="col-sm-5 col-xs-6 tital " >Email:</div><div class="col-sm-7">"""),_display_(/*313.75*/if(user!=null)/*313.89*/{_display_(_display_(/*313.91*/user/*313.95*/.getEmail))}),format.raw/*313.105*/("""</div>
  <div class="clearfix"></div>
<div class="bot-border"></div>

<div class="col-sm-5 col-xs-6 tital " >Address:</div><div class="col-sm-7">"""),_display_(/*317.77*/if(user!=null)/*317.91*/{_display_(_display_(/*317.93*/user/*317.97*/.getAddress))}),format.raw/*317.109*/("""</div>

 <div class="clearfix"></div>
<div class="bot-border"> <center><a href=""""),_display_(/*320.44*/routes/*320.50*/.ProductCtrl.listProducts(0)),format.raw/*320.78*/("""">

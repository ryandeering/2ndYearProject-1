			...
			<table class="table table-bordered table-hover table-condensed">
				...
				<tbody>
					...
					"""),format.raw/*58.6*/("""<tr>
						...
						<td>"""),_display_(/*67.12*/p/*67.13*/.stockShortage),format.raw/*67.27*/("""</td>
						<td>&euro; """),_display_(/*68.19*/("%.2f".format(p.getPrice))),format.raw/*68.46*/("""</td>
						"""),_display_(/*69.8*/if(p.getStock() > 0)/*69.28*/{_display_(Seq[Any](format.raw/*69.29*/("""
							"""),format.raw/*70.8*/("""<td><a href=""""),_display_(/*70.22*/routes/*70.28*/.ShoppingCtrl.addToBasket(p.getId)),format.raw/*70.62*/(""""  class="btn btn-default btn-xs"><span class="glyphicon glyphicon-shopping-cart"></span></a></td>
						""")))}/*71.8*/else/*71.12*/{_display_(Seq[Any](format.raw/*71.13*/("""
							"""),format.raw/*72.8*/("""<td></td>
						""")))}),format.raw/*73.8*/("""
						"""),format.raw/*74.7*/("""</tr>
					 """)))}),format.raw/*75.8*/("""
